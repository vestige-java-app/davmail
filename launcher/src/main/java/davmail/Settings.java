...
public final class Settings {
     ...
     */
    public static synchronized void setConfigFilePath(final String path) {
        configFilePath = path;
    }
     ...
     */
    public static synchronized void load(final InputStream inputStream) throws IOException {
     ...
     * @return property value
     */
    public static synchronized String getProperty(final String property, final String defaultValue) {
        String value = SETTINGS.getProperty(property);
        if (value == null) {
            value = defaultValue;
        }
     ...
     * @return property value
     */
    public static synchronized char[] getCharArrayProperty(final String property) {
     ...
     * @return property value
     */
    public static synchronized int getIntProperty(final String property) {
     ...
     * @return property value
     */
    public static synchronized int getIntProperty(final String property, final int defaultValue) {
     ...
     * @return property value
     */
    public static synchronized boolean getBooleanProperty(final String property) {
        String propertyValue = SETTINGS.getProperty(property);
     ...
     * @return property value
     */
    public static synchronized boolean getBooleanProperty(final String property, final boolean defaultValue) {
     ...
     * @return prefix
     */
    private static String getLoggingPrefix(final String category) {
        String prefix;
     ...
     */
    public static synchronized Level getLoggingLevel(final String category) {
     ...
     * @return properties
     */
    public static synchronized Properties getSubProperties(final String scope) {
     ...
     */
    public static synchronized void setLoggingLevel(final String category, final Level level) {
        String prefix = getLoggingPrefix(category);
     ...
     * @param value    property value
     */
    public static synchronized void saveProperty(final String property, final String value) {
        Settings.load();
        Settings.setProperty(property, value);
        Settings.save();
    }
